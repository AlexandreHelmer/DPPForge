...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='DPPForge <contact@dppforge.com>')

# Contact Email for the /contact endpoint
CONTACT_EMAIL = config('CONTACT_EMAIL', default='contact@dppforge.com')
